...
def encode_image(img, data, output_path):
    ...
    # Adding a 32-bit header to store the length of the data
...
def main():
    ...
    parser.add_argument("--data", help="Data file for encoding", required=False)
    ...
    if args.mode == "encode":
        ...
        data = load_binary_data(args.data)
